...
{/* Left side */} 
    <div className="flex justify-between items-center gap-5">
      <button
       className="px-3 py-3 bg-gray-100 rounded-full hover:bg-blue-100" onClick={() => {}}>
    ...
    <div className="flex justify-between items-center gap-5">
      ...
      <div className="relative">
        ...
        <span className="absolute -top-2 -right-2 inline-flex items-center justify-center px-[0.4rem] py-1 text-xs font-bold leading-none text-white bg-red-600 rounded-full">3</span>
      </div>
